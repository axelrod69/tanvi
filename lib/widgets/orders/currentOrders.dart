...
class CurrentOrdersState extends State<CurrentOrders> {
  final Map<String, dynamic> _currentOrders = {
    'data': [
      {
        'id': 1,
        'name': 'Pizza Corner',
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ListView.builder(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                    '(${_currentOrders['data'][index]['totalRatings'].toString()} ratings)',
                                                    textScaleFactor: textScale,
                                                    style: const TextStyle(
                                                        color: Colors.black,
                                                        fontSize: 12))
            ...
            itemCount: _currentOrders['data'].length),
      ),
    );
  }
}
